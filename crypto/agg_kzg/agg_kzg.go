...
import (
	...
	// After PR 3038 is merged, ssz will be removed
	ssz "github.com/prysmaticlabs/fastssz"
	"github.com/prysmaticlabs/prysm/v3/crypto/hash"

	// After PR 3038 is merged, this will no longer be needed
	// since the crypto library itself will define a polynomial
	// struct that will be used
	v1 "github.com/prysmaticlabs/prysm/v3/proto/engine/v1"

	// After PR 3038 is merged, this import will no longer be used
	// since we will not be using ssz
...
// Verifies a KZG opening proof over multiple polynomials evaluated at the same point
func VerifyAggregateKZGProof(commitments [][]byte, blobs []*v1.Blob, aggregatedProof []byte) error {
	...
	b, err := verifyKZGProof(aggregatedPolyCommitment, &x, &y, aggregatedProof)
	if err != nil {
		return err
	}
	if !b {
